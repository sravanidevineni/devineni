pipeline {
  ...
  stages {
   ...
   stage('Docker build and push') {
	 ...
	 docker build -t 008471392674.dkr.ecr.ap-south-1.amazonaws.com/vivek/sample:SAMPLE-PROJECT-${BUILD_NUMBER} .
         docker push 008471392674.dkr.ecr.ap-south-1.amazonaws.com/vivek/sample:SAMPLE-PROJECT-${BUILD_NUMBER}
